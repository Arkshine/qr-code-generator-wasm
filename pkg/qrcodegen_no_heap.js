...
const WasmQrCodeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmqrcode_free(ptr >>> 0, 1));
...
export class WasmQrCode {
    ...
    generate(text, ecc_level, min_version, max_version, mask, boost_ecl) {
        ...
        const ret = wasm.wasmqrcode_generate(this.__wbg_ptr, ptr0, len0, ecc_level, min_version, max_version, isLikeNone(mask) ? 0xFFFFFF : mask, boost_ecl);
        if (ret[1]) {
    ...
    to_png(fg_color, bg_color, quiet_zone) {
        ...
        const ret = wasm.wasmqrcode_to_png(this.__wbg_ptr, ptr0, len0, ptr1, len1, quiet_zone);
        if (ret[2]) {
